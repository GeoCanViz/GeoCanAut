    ...
    define(['jquery-private',
        ...
        initialize = function(elem) {
            ...
            var toolsOrderViewModel = function(elem) {
                ...
                _self.toolsTmp = [{ label: 'a'}, { label: 'a'}, { label: 'a'}, { label: 'a'}, { label: 'a'}];
                ...
                _self.read = function(vm, label) {
                    if (gcautFunc.getElemValueVM(vm, 'isEnable')) {
                        var pos = gcautFunc.getElemValueVM(vm, 'pos');
                        _self.toolsTmp[pos] = { label: label,
                                               vm: vm
                                              };
                        gcautFunc.setElemValueVM(vm, 'pos', pos);
                        position++;
                    }
                };
